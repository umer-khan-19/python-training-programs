...
"""
height,base = map(float,input("Enter height and base by spacing between them for calculating the area of triangle:").split())
area_of_a_triangle = 0.5*height*base
